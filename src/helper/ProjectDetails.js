...
export const ProjectDetails = [
    {
        ...
        skills:["Html", "React", "React Scroll", "React Router Dom", "Sass"],
        picture: eLearning,
    ...
    },
    {
        ...
        skills:["React", "Flexbox", "Grid","Tailwindcss", "Mobile first workflow"],
        picture: beachResort,
    ...
    },
    {
        ...
        skills:["Html", "Css", "React","Flex Box", "React Router Dom", "Grid", "Css Custom Properties"],
    ...
    },
    {
        ...
        skills:["Html", "Css", "React","Advice Slip API","Flex Box"],
    ...
    },
    {
        ...
        skills:["Html", "Css", "Javascript","Flex Box", "CSS Custom Properties", "Mobile first workflow", "responsive"],
        picture: signUp,
